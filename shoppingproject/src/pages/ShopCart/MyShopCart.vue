  ...
  methods: {
    ...
    handler: throttle(async function (type, disNum, cart) {
      ...
      switch (type) {
        ...
        //文本框变化
        case "change":
          //用户输入进来的最终量，如果是非法的（带有各种字符和汉字或者出现负数），带给服务器数字
